                ...
                <div key={index} className="toShip-main-container">
                    <div className="infos-container">
                        ...
                        <div className="button-container">
                            <button onClick={()=>{setToRecieve(order.userId,order.orderId)}}>To Receive</button>
                        </div>
                    </div>
                </div>
            ))
