...
const UpAndLowLand = (props) => {
  ...
  const [currentPage, setCurrentPage] = useState(1);
    ...
    const totalPages = Math.ceil((props.data.filter((item)=>item.category==='Upland Vegetables'||item.category==='Lowland Vegetables')).length / itemsPerPage);
...
UpAndLowLand.propTypes = {
  data: PropTypes.arrayOf(PropTypes.object).isRequired,
  authorizedUser: PropTypes.object,
};
export default UpAndLowLand