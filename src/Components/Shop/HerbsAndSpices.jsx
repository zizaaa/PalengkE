...
const HerbsAndSpices = () => {
  ...
  const [isUserLoading,setIsUserLoading] = useState(true);
    ...
    const totalPages = Math.ceil((data.filter((item)=>item.category==='Herbs & Spices')).length / itemsPerPage);
            ...
            {isProductLoading ? <ProductsSkeleton />:data.filter((item,index,data)=>{
                if(item.category==='Herbs & Spices'){
                  if(sort === ''){
                    ...
                    return data.sort((a,b)=> a.price - b.price)[index]
                  }else if(sort === 'High'){
                    return data.sort((a,b)=> b.price - a.price)[index]
                  }
                }
