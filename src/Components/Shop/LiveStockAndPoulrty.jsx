...
const LiveStockAndPoulrty = (props) => {
  ...
  const [toLoading,setToLoading] = useState('');
    ...
    const totalPages = Math.ceil((props.data.filter((item)=>item.category==='Livestock and Poultry Products')).length / itemsPerPage);
...
LiveStockAndPoulrty.propTypes = {
  data: PropTypes.arrayOf(PropTypes.object).isRequired,
  authorizedUser: PropTypes.object,
};
export default LiveStockAndPoulrty